...
public class DrawingFrame extends JFrame {
	private JButton jbLine, jbCircle, jbRectangle, clear, selectOrMove;
	...
	public DrawingFrame() {
		...
		selectOrMove = new JButton("SelectOrMove");
		...
		toolboxPanel.add(selectOrMove);
		toolboxPadding.add(statusLabel);
		...
		selectOrMove.addActionListener(buttonHandler);
		...
		public void windowClosing(WindowEvent e) {
			int choose = JOptionPane.showConfirmDialog(null, "Do you really want to exit the application ?", "Confirm Close", JOptionPane.YES_NO_OPTION,
	...
	private class ButtonHandler implements ActionListener {
		public void actionPerformed( ActionEvent event ) {
			...
			} else if (event.getActionCommand().equals("SelectOrMove")) {
